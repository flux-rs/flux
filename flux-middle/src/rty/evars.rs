...
pub struct EVarGen {
    evars: FxHashMap<EVarCx, IndexVec<EVid, EVarState>>,
}

#[derive(Debug)]
pub struct EVarSol {
    evars: FxHashMap<EVarCx, IndexVec<EVid, Expr>>,
}
...
impl EVarGen {
    ...
    pub fn new_ctxt(&mut self) -> EVarCx {
        let cx = EVarCx(NEXT_CTXT_ID.fetch_add(1, Relaxed));
    ...
    /// # Panics
    ///
    /// This function panics if the context `cx` was not generated by this instance.
    pub fn fresh_in_cx(&mut self, cx: EVarCx) -> EVar {
