...
use crate::{
    constraint::{BinOp, BinRel, Constant, Constraint, Expr, Pred, Sort}, ConstDecl, Error, FixpointFmt, FixpointResult, FlatConstraint, Identifier, Stats, ThyFunc, Types
};
...
impl<T: Types> Env<T> {
    pub(crate) fn new() -> Self {
        Self { bindings: HashMap::new(), rev_bindings: HashMap::new() }
    }
