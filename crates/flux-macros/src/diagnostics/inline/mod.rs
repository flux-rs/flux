//! Copy of `compiler/rustc_macros/src/diagnostics` from rustc `8925ea358` (nightly-2026-08-21).
//!
//! Keep this as close to upstream as possible so syncing is a plain diff. Local changes are marked
//! with `// flux:` comments. While the old derive still lives in the parent module, all
//! `crate::diagnostics::` paths are rewritten to `crate::diagnostics::inline::`.
