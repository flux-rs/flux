...
pub fn sum_pair(p: Pair) -> i32 {
    p.x + p.y + 1 //~ ERROR refinement type
}
...
pub fn mk_pair_with_first(a: i32) -> Pair {
    Pair { x: 0, y: a } //~ ERROR refinement type
}
...
pub fn mk_pair_with_bound(a: i32) -> Pair {
    Pair { x: a, y: a } //~ ERROR refinement type
}
