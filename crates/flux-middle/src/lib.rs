...
pub struct Specs {
    ...
    /// Set of dummy items generated by extern spec macro we must completely ignore. If an item
    /// is marked as dummy so are its descendants.
...
impl Specs {
    ...
    fn is_dummy(&self, def_id: LocalDefId) -> bool {
        self.dummy_extern.contains(&def_id)
    }
}
