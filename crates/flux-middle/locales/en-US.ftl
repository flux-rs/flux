...
middle_query_opaque_struct_derive_help =
    help: this code was generated by a `#[derive(..)]` and cannot be annotated directly; try annotating this type with `#[flux::trusted_derive]`
