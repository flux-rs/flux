...
use flux_config::{self as config, OverflowMode, PartialInferOpts, RawPointerMode, SmtSolver};
...
impl AttrMap {
    ...
    fn try_into_infer_opts(&mut self) -> AttrMapErr<PartialInferOpts> {
        ...
        try_read_setting!(self, check_raw_pointer, RawPointerMode, infer_opts);
