...
use flux_middle::rty::{self, fold::{FallibleTypeFolder, TypeFoldable, TypeSuperFoldable}};
...
impl<'a> FallibleTypeFolder for WKVarInstantiator<'a> {
    ...
    fn try_fold_binder<T: TypeFoldable>(&mut self, t: &rty::Binder<T>) -> Result<rty::Binder<T>, rty::Var> {
