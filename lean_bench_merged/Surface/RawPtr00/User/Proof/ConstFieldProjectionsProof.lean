...
import Surface.RawPtr00.Flux.VC.ConstFieldProjections
open Classical
...
namespace ConstFieldProjectionsQualifs
...
end ConstFieldProjectionsQualifs

open ConstFieldProjectionsQualifs

set_option maxHeartbeats 5000000
#time def ConstFieldProjections_proof : ConstFieldProjections := by
  unfold ConstFieldProjections
