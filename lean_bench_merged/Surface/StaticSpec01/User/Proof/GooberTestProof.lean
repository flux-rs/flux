...
import Surface.StaticSpec01.Flux.VC.GooberTest
open Classical
...
end GooberTestQualifs

open GooberTestQualifs

set_option maxHeartbeats 5000000
#time def GooberTest_proof : GooberTest := by
  unfold GooberTest
