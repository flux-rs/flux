...
import Surface.Binop.Flux.VC.LogicalOrFt
open Classical
...
end LogicalOrFtQualifs

open LogicalOrFtQualifs

set_option maxHeartbeats 5000000
#time def LogicalOrFt_proof : LogicalOrFt := by
  unfold LogicalOrFt
