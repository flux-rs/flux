import LeanFixpoint
import Surface.CheckOverflow03.Flux.Prelude
import Surface.CheckOverflow03.Flux.VC.Impl__0__Add
open Classical
...
#time def Impl__0__Add_proof : Impl__0__Add := by
  unfold Impl__0__Add
