import LeanFixpoint
import Surface.Issue743.Flux.Prelude
import Surface.Issue743.Flux.VC.RunClosure
open Classical
...
end RunClosureQualifs

open RunClosureQualifs

set_option maxHeartbeats 5000000
#time def RunClosure_proof : RunClosure := by
  unfold RunClosure
