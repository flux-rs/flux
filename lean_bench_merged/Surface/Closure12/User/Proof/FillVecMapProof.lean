...
import Surface.Closure12.Flux.VC.FillVecMap
open Classical
...
end FillVecMapQualifs

open FillVecMapQualifs

set_option maxHeartbeats 5000000
#time def FillVecMap_proof : FillVecMap := by
  unfold FillVecMap
