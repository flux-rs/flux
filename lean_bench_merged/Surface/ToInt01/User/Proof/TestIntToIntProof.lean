...
import Surface.ToInt01.Flux.VC.TestIntToInt
open Classical
...
end TestIntToIntQualifs

open TestIntToIntQualifs

set_option maxHeartbeats 5000000
#time def TestIntToInt_proof : TestIntToInt := by
  unfold TestIntToInt
