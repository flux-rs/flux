...
// Module: UserQualifiers.WellFormed.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_UserQualifiers_WellFormed_Flux_Prelude(uint8_t builtin) {
lean_object * res;
