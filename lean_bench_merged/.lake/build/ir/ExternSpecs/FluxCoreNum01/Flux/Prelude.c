...
// Module: ExternSpecs.FluxCoreNum01.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_ExternSpecs_FluxCoreNum01_Flux_Prelude(uint8_t builtin) {
lean_object * res;
