...
// Module: ExternSpecs.FluxCoreSlice00.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_ExternSpecs_FluxCoreSlice00_Flux_Prelude(uint8_t builtin) {
lean_object * res;
