...
// Module: ExternSpecs.FluxCoreNum00.Flux.VC.TestCheckedDivUsize
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_ExternSpecs_FluxCoreNum00_Flux_VC_TestCheckedDivUsize(uint8_t builtin) {
lean_object * res;
