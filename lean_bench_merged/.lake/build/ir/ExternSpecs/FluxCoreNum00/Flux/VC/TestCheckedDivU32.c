...
// Module: ExternSpecs.FluxCoreNum00.Flux.VC.TestCheckedDivU32
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_ExternSpecs_FluxCoreNum00_Flux_VC_TestCheckedDivU32(uint8_t builtin) {
lean_object * res;
