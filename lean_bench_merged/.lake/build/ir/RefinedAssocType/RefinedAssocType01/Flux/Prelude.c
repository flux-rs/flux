...
// Module: RefinedAssocType.RefinedAssocType01.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_RefinedAssocType_RefinedAssocType01_Flux_Prelude(uint8_t builtin) {
lean_object * res;
