...
// Module: Lifetimes.StructGenericLifetimeMut.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_Lifetimes_StructGenericLifetimeMut_Flux_Prelude(uint8_t builtin) {
lean_object * res;
