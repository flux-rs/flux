...
// Module: Surface.LocalQual00.Flux.VC.RvecImpl__4__IndexMut
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_Surface_LocalQual00_Flux_VC_RvecImpl____4____IndexMut(uint8_t builtin) {
lean_object * res;
