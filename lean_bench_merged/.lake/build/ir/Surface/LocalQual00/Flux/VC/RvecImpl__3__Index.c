...
// Module: Surface.LocalQual00.Flux.VC.RvecImpl__3__Index
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_Surface_LocalQual00_Flux_VC_RvecImpl____3____Index(uint8_t builtin) {
lean_object * res;
