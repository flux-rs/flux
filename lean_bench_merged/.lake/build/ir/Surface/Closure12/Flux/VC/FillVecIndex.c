...
// Module: Surface.Closure12.Flux.VC.FillVecIndex
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_Surface_Closure12_Flux_VC_FillVecIndex(uint8_t builtin) {
lean_object * res;
