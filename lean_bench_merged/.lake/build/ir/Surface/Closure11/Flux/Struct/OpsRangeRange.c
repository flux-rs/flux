...
// Module: Surface.Closure11.Flux.Struct.OpsRangeRange
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_Surface_Closure11_Flux_Struct_OpsRangeRange(uint8_t builtin) {
lean_object * res;
