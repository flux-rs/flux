...
// Module: Surface.PartiallyUninitTuple.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_Surface_PartiallyUninitTuple_Flux_Prelude(uint8_t builtin) {
lean_object * res;
