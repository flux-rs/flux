...
// Module: Detached.DetachImpl05Macro.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_Detached_DetachImpl05Macro_Flux_Prelude(uint8_t builtin) {
lean_object * res;
