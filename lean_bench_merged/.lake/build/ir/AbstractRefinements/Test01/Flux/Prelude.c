...
// Module: AbstractRefinements.Test01.Flux.Prelude
...
LEAN_EXPORT lean_object* initialize_lean__bench__all_AbstractRefinements_Test01_Flux_Prelude(uint8_t builtin) {
lean_object * res;
