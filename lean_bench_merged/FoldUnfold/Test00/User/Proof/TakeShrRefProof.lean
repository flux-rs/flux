...
import FoldUnfold.Test00.Flux.VC.TakeShrRef
open Classical
...
end TakeShrRefQualifs

open TakeShrRefQualifs

set_option maxHeartbeats 5000000
#time def TakeShrRef_proof : TakeShrRef := by
  unfold TakeShrRef
