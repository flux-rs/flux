...
import FoldUnfold.Test00.Flux.VC.TakeMutRef
open Classical
...
end TakeMutRefQualifs

open TakeMutRefQualifs

set_option maxHeartbeats 5000000
#time def TakeMutRef_proof : TakeMutRef := by
  unfold TakeMutRef
