...
import Vec.Vec00.Flux.VC.TestIsEmpty
open Classical
...
end TestIsEmptyQualifs

open TestIsEmptyQualifs

set_option maxHeartbeats 5000000
#time def TestIsEmpty_proof : TestIsEmpty := by
  unfold TestIsEmpty
