...
import ExternSpecs.FluxCoreNum00.Flux.VC.TestCheckedUsize
open Classical
...
namespace TestCheckedUsizeQualifs
...
end TestCheckedUsizeQualifs

open TestCheckedUsizeQualifs

set_option maxHeartbeats 5000000
#time def TestCheckedUsize_proof : TestCheckedUsize := by
  unfold TestCheckedUsize
