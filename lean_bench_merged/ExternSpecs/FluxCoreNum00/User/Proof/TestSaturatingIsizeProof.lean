...
import ExternSpecs.FluxCoreNum00.Flux.VC.TestSaturatingIsize
open Classical
...
namespace TestSaturatingIsizeQualifs
...
end TestSaturatingIsizeQualifs

open TestSaturatingIsizeQualifs

set_option maxHeartbeats 5000000
#time def TestSaturatingIsize_proof : TestSaturatingIsize := by
