...
import ExternSpecs.FluxCoreNum00.Flux.VC.TestCheckedMulUsize
open Classical
...
namespace TestCheckedMulUsizeQualifs
...
end TestCheckedMulUsizeQualifs

open TestCheckedMulUsizeQualifs

set_option maxHeartbeats 5000000
#time def TestCheckedMulUsize_proof : TestCheckedMulUsize := by
  unfold TestCheckedMulUsize
