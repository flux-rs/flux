...
import ExternSpecs.FluxCoreOption00.Flux.VC.TestOkOrSome
open Classical
...
end TestOkOrSomeQualifs

open TestOkOrSomeQualifs

set_option maxHeartbeats 5000000
#time def TestOkOrSome_proof : TestOkOrSome := by
  unfold TestOkOrSome
