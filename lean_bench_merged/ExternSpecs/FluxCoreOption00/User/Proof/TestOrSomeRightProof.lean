...
import ExternSpecs.FluxCoreOption00.Flux.VC.TestOrSomeRight
open Classical
...
namespace TestOrSomeRightQualifs
...
end TestOrSomeRightQualifs

open TestOrSomeRightQualifs

set_option maxHeartbeats 5000000
#time def TestOrSomeRight_proof : TestOrSomeRight := by
  unfold TestOrSomeRight
