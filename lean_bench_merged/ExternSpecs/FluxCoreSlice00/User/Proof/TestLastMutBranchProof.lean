...
import ExternSpecs.FluxCoreSlice00.Flux.VC.TestLastMutBranch
open Classical
...
namespace TestLastMutBranchQualifs
...
end TestLastMutBranchQualifs

open TestLastMutBranchQualifs

set_option maxHeartbeats 5000000
#time def TestLastMutBranch_proof : TestLastMutBranch := by
