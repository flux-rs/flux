...
import ExternSpecs.FluxCoreSlice00.Flux.VC.TestIterAsSliceLen
open Classical
...
namespace TestIterAsSliceLenQualifs
...
end TestIterAsSliceLenQualifs

open TestIterAsSliceLenQualifs

set_option maxHeartbeats 5000000
#time def TestIterAsSliceLen_proof : TestIterAsSliceLen := by
