...
import ExternSpecs.FluxCoreSlice00.Flux.VC.TestFirstBranch
open Classical
...
namespace TestFirstBranchQualifs
...
end TestFirstBranchQualifs

open TestFirstBranchQualifs

set_option maxHeartbeats 5000000
#time def TestFirstBranch_proof : TestFirstBranch := by
