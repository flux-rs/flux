import LeanFixpoint
import ExternSpecs.ExternSpecStruct03.Flux.Prelude
import ExternSpecs.ExternSpecStruct03.Flux.VC.Assert
open Classical
...
#time def Assert_proof : Assert := by
  unfold Assert
