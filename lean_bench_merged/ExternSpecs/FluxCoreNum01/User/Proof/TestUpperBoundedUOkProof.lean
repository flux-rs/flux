...
import ExternSpecs.FluxCoreNum01.Flux.VC.TestUpperBoundedUOk
open Classical
...
namespace TestUpperBoundedUOkQualifs
...
end TestUpperBoundedUOkQualifs

open TestUpperBoundedUOkQualifs

set_option maxHeartbeats 5000000
#time def TestUpperBoundedUOk_proof : TestUpperBoundedUOk := by
  unfold TestUpperBoundedUOk
