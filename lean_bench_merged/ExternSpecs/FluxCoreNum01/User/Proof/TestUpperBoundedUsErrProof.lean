...
import ExternSpecs.FluxCoreNum01.Flux.VC.TestUpperBoundedUsErr
open Classical
...
namespace TestUpperBoundedUsErrQualifs
...
end TestUpperBoundedUsErrQualifs

open TestUpperBoundedUsErrQualifs

set_option maxHeartbeats 5000000
#time def TestUpperBoundedUsErr_proof : TestUpperBoundedUsErr := by
  unfold TestUpperBoundedUsErr
