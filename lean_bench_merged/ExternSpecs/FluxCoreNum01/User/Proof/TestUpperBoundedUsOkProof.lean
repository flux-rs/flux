...
import ExternSpecs.FluxCoreNum01.Flux.VC.TestUpperBoundedUsOk
open Classical
...
namespace TestUpperBoundedUsOkQualifs
...
end TestUpperBoundedUsOkQualifs

open TestUpperBoundedUsOkQualifs

set_option maxHeartbeats 5000000
#time def TestUpperBoundedUsOk_proof : TestUpperBoundedUsOk := by
  unfold TestUpperBoundedUsOk
