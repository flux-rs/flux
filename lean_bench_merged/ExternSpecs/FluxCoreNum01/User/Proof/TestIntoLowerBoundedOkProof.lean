...
import ExternSpecs.FluxCoreNum01.Flux.VC.TestIntoLowerBoundedOk
open Classical
...
namespace TestIntoLowerBoundedOkQualifs
...
end TestIntoLowerBoundedOkQualifs

open TestIntoLowerBoundedOkQualifs

set_option maxHeartbeats 5000000
#time def TestIntoLowerBoundedOk_proof : TestIntoLowerBoundedOk := by
  unfold TestIntoLowerBoundedOk
