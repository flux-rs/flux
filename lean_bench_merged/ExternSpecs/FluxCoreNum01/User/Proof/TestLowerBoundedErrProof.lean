...
import ExternSpecs.FluxCoreNum01.Flux.VC.TestLowerBoundedErr
open Classical
...
namespace TestLowerBoundedErrQualifs
...
end TestLowerBoundedErrQualifs

open TestLowerBoundedErrQualifs

set_option maxHeartbeats 5000000
#time def TestLowerBoundedErr_proof : TestLowerBoundedErr := by
  unfold TestLowerBoundedErr
