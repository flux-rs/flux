...
use super::{
    pure::{BinOp, Constant, Expr, ExprKind, ExprS, Var},
    Ty, TyKind, TyS,
};
...
impl LrCtxt {
    ...
    pub fn mk_int(&self, n: Expr, int_ty: IntTy) -> Ty {
        self.mk_ty(TyKind::Int(n, int_ty))
    }

    pub fn mk_uint(&self, n: Expr, int_ty: UintTy) -> Ty {
        self.mk_ty(TyKind::Uint(n, int_ty))
    }
