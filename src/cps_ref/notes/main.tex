...
\begin{mathpar}
  ...
  [\textsc{F-letcont}]
  {
    \tfun{\Gamma'}{\tenv',\bar{x:\own{\ell}}}{\kenv,k:\cont{\Gamma';\tenv';\bar{\ell\,}}}{F_1}
    \\\\
  ...
  [\textsc{F-jump}]
  {
    ...
    \envsubst{\Gamma;\tenv}{\Gamma';\tenv'*\bar{x:\own{\ell}}}{\theta} \\\\
    \envincl{\tenv}{\bar{x:\own{\ell}}*\tenv'} \\
  ...
  [\textsc{F-call}]
  {
    ...
    \\\\
    \envsubst{\Gamma;\tenv}{\Gamma_f;\bar{x:\own{\ell_f}}}{\theta_1} \\
    \envsubst{\Gamma;\tenv*y:\own{\ell_o}}{\Gamma_k;\tenv_k*y:\own{\ell_k}}{\theta_2} \\
    \\\\
...
\begin{mathpar}
  \boxed{\envsubst{\Gamma_1;\tenv_1}{\Gamma_2;\tenv_2}{\theta}}\hfill\,
  \\

  \infer{}{\envsubst{\Gamma_1;\tenv_1}{\Gamma_2;\emptyset}{\emptyset}}

  \infer
  {\own{\ell_1} = \tenv_1(x) \\ \envsubst{\Gamma_1;\tenv_1}{\Gamma_2;\tenv_2}{\theta_1} \\
   \subst{\Gamma_1(\ell_1);\Gamma_2(\ell_2)} = \theta_2
  }
  {\envsubst{\Gamma_1;\tenv_1}{\Gamma_2;\tenv_2,x:\own{\ell_2}}{\theta_1 \cdot \theta_2 \cdot [\ell_1/\ell_2]}}
\end{mathpar}

% \begin{metafun}{\subst{\Gamma_1,\tenv_1;\Gamma_2,\tenv_2} = \theta}
%   \subst{\Gamma_1,\tenv_1;\Gamma_2,\tenv_2,x:\own{\ell_2}} &=& \theta_1 \cdot \theta_2 \cdot [\ell_1/\ell_2] \\
%   \whereblock{
%     \own{\ell_1} &=& \tenv_1(x)                                \\
%     \theta_2     &=& \subst{\tenv_1; \tenv_2}                  \\
%     \theta_2     &=& \subst{\Gamma_1(\ell_1);\Gamma_2(\ell_2)}
%   }
% \end{metafun}
