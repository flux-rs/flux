...
// TODO(RJ): TRIVIAL-ARG
//
// fn trivial_arg(rust_arg: &rustc_ty::GenericArg) -> Ty<Res> {
//     match rust_arg {
//         rustc_ty::GenericArg::Ty(ty) => trivial_ty(ty),
//     }
// }

// fn trivial_ty(_ty: &rustc_ty::Ty) -> Ty<Res> {
//     todo!()
// }
