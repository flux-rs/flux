...
#[lr::sig(fn(&RMat<f32>[m, n], m: usize{m > 0}, n: usize{n > 0}) -> bool)]
...
#[lr::sig(fn(m: usize{m > 0}, n: usize{n > 0}, &RMat<f32>[m, n]) -> bool)]
...
#[lr::sig(fn(m: usize{m > 0}, n: usize{n > 2}, &RMat<f32>[m,n]) -> usize{v: 0 < v && v+1 < n})]
...
#[lr::sig(fn(m: usize, n: usize, &RMat<f32>[m, n], usize{v : 0 < v && v < n}, usize{v : 0 < v && v < m}, f32) -> usize{v : 0 < v && v < m})]
