...
pub fn test_neg01() {
    test_neg00(1, 1); //~ ERROR precondition
}

#[flux::sig(fn(x: i32) -> i32[x/2])]
pub fn test_div(x: i32) -> i32 {
    x / 2 + 1 //~ ERROR postcondition
}
...
pub fn test_neq01() {
    test_neq00(0, 0); //~ ERROR precondition
}
...
pub fn test_not01() {
    test_not00(1); //~ ERROR precondition
}
...
pub fn test_not03() {
    test_not02(true, true); //~ ERROR precondition
}
