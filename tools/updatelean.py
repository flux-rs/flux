...
def run_lake_update(directory: Path) -> tuple[bool, str]:
    """
    Run 'lake update' in the given directory.
...
def main():
    parser = argparse.ArgumentParser(
        description="Recursively run lake update in all lean_proofs directories"
    )
    parser.add_argument(
        "path",
        type=str,
    ...
    for lean_dir in sorted(lean_dirs):
        ...
        success, error_output = run_lake_update(lean_dir)
