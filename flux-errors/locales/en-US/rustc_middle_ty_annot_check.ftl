...
rustc_middle_ty_annot_check_field_count_mismatch =
...
rustc_middle_ty_annot_check_path_mismatch =
    invalid refinement annotation
    .label =  expected `{$rust_type}`, found `{$flux_type}`

rustc_middle_ty_annot_check_invalid_refinement =
    invalid refinement annotation
    .label = not a valid refinement of `{$rust_type}`

rustc_middle_ty_annot_check_mutability_mismatch =
    mismatched types
    .label = types differ in mutability

rustc_middle_ty_annot_check_default_return_mismatch =
    return type mismatch
    .label = expected `{$rust_type}`, found `()`

rustc_middle_ty_annot_check_too_few_arguments =
...
rustc_middle_ty_annot_check_too_many_arguments =
...
rustc_middle_ty_annot_check_invalid_refinement_for_def =
    refinement annotation for this {$def_kind} is invalid

rustc_middle_ty_annot_check_definition_span_note =
