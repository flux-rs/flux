...
import LeanProofs.Flux.VC.Impl__Update2
open Classical

namespace F

namespace ImplUpdate2Qualifs
...
end ImplUpdate2Qualifs

open ImplUpdate2Qualifs

def Impl__Update2_proof : Impl__Update2 := by
  unfold Impl__Update2
  try solve_fixpoint
