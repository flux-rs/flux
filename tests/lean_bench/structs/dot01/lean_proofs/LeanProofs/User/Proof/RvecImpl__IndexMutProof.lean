...
import LeanProofs.Flux.VC.RvecImpl__IndexMut
open Classical

namespace F

namespace RvecImplIndexMutQualifs
...
end RvecImplIndexMutQualifs

open RvecImplIndexMutQualifs

def RvecImpl__IndexMut_proof : RvecImpl__IndexMut := by
  unfold RvecImpl__IndexMut
  try solve_fixpoint
