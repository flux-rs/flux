...
import LeanProofs.Flux.VC.RvecImpl__Index
open Classical

namespace F

namespace RvecImplIndexQualifs
...
end RvecImplIndexQualifs

open RvecImplIndexQualifs

def RvecImpl__Index_proof : RvecImpl__Index := by
  unfold RvecImpl__Index
  try solve_fixpoint
