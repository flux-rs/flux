...
import LeanProofs.Flux.VC.MkPairWithPos
open Classical

namespace F

namespace MkPairWithPosQualifs
...
end MkPairWithPosQualifs

open MkPairWithPosQualifs

set_option maxHeartbeats 5000000
def MkPairWithPos_proof : MkPairWithPos := by
