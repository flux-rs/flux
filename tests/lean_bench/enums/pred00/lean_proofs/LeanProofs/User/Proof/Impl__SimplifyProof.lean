...
import LeanProofs.Flux.VC.Impl__Simplify
open Classical

namespace F

namespace ImplSimplifyQualifs
...
end ImplSimplifyQualifs

open ImplSimplifyQualifs

set_option maxHeartbeats 1200000

def Impl__Simplify_proof : Impl__Simplify := by
  unfold Impl__Simplify
  try solve_fixpoint
