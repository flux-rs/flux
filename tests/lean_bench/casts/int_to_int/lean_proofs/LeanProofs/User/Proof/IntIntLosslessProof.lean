...
import LeanProofs.Flux.VC.IntIntLossless
open Classical
...
namespace IntIntLosslessQualifs
...
end IntIntLosslessQualifs

open IntIntLosslessQualifs

set_option maxHeartbeats 5000000
def IntIntLossless_proof : IntIntLossless := by
