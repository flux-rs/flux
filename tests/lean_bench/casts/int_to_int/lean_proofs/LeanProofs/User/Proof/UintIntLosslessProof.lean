...
import LeanProofs.Flux.VC.UintIntLossless
open Classical
...
namespace UintIntLosslessQualifs
...
end UintIntLosslessQualifs

open UintIntLosslessQualifs

set_option maxHeartbeats 5000000
def UintIntLossless_proof : UintIntLossless := by
