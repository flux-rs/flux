...
import LeanProofs.Flux.VC.TestIterForLoopSlice
open Classical
...
namespace TestIterForLoopSliceQualifs
...
end TestIterForLoopSliceQualifs

open TestIterForLoopSliceQualifs

set_option maxHeartbeats 5000000
#time def TestIterForLoopSlice_proof : TestIterForLoopSlice := by
