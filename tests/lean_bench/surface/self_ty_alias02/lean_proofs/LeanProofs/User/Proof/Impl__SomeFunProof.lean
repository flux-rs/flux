...
import LeanProofs.Flux.VC.Impl__SomeFun
open Classical

namespace F

namespace ImplSomeFunQualifs
...
end ImplSomeFunQualifs

open ImplSomeFunQualifs

def Impl__SomeFun_proof : Impl__SomeFun := by
  unfold Impl__SomeFun
  try solve_fixpoint
