...
import LeanProofs.Flux.VC.Impl__Enqueue
open Classical

namespace F

namespace ImplEnqueueQualifs
...
end ImplEnqueueQualifs

open ImplEnqueueQualifs

def Impl__Enqueue_proof : Impl__Enqueue := by
  unfold Impl__Enqueue
  try solve_fixpoint
