...
import LeanProofs.Flux.VC.Impl__Location
open Classical

namespace F

namespace ImplLocationQualifs
...
end ImplLocationQualifs

open ImplLocationQualifs

def Impl__Location_proof : Impl__Location := by
  unfold Impl__Location
  try solve_fixpoint
