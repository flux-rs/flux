...
import LeanProofs.Flux.VC.Impl__TakeMut
open Classical

namespace F

namespace ImplTakeMutQualifs
...
end ImplTakeMutQualifs

open ImplTakeMutQualifs

def Impl__TakeMut_proof : Impl__TakeMut := by
  unfold Impl__TakeMut
  try solve_fixpoint
