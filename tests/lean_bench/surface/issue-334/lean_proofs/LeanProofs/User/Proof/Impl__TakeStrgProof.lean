...
import LeanProofs.Flux.VC.Impl__TakeStrg
open Classical

namespace F

namespace ImplTakeStrgQualifs
...
end ImplTakeStrgQualifs

open ImplTakeStrgQualifs

def Impl__TakeStrg_proof : Impl__TakeStrg := by
  unfold Impl__TakeStrg
  try solve_fixpoint
