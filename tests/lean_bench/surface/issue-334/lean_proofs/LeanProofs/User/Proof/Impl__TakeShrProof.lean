...
import LeanProofs.Flux.VC.Impl__TakeShr
open Classical

namespace F

namespace ImplTakeShrQualifs
...
end ImplTakeShrQualifs

open ImplTakeShrQualifs

def Impl__TakeShr_proof : Impl__TakeShr := by
  unfold Impl__TakeShr
  try solve_fixpoint
