...
import LeanProofs.Flux.VC.Impl__TryFrom
open Classical

namespace F

namespace ImplTryFromQualifs
...
end ImplTryFromQualifs

open ImplTryFromQualifs

def Impl__TryFrom_proof : Impl__TryFrom := by
  unfold Impl__TryFrom
  try solve_fixpoint
