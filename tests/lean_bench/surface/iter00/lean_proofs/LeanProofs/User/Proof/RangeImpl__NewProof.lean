...
import LeanProofs.Flux.VC.RangeImpl__New
open Classical

namespace F

namespace RangeImplNewQualifs
...
end RangeImplNewQualifs

open RangeImplNewQualifs

def RangeImpl__New_proof : RangeImpl__New := by
  unfold RangeImpl__New
  try solve_fixpoint
