...
import LeanProofs.Flux.VC.GhostCellImpl__3__Take
open Classical

namespace F

namespace GhostCellImpl3TakeQualifs
...
end GhostCellImpl3TakeQualifs

open GhostCellImpl3TakeQualifs

def GhostCellImpl__3__Take_proof : GhostCellImpl__3__Take := by
