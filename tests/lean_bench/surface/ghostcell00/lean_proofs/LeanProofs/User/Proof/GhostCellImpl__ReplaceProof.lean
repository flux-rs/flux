...
import LeanProofs.Flux.VC.GhostCellImpl__Replace
open Classical

namespace F

namespace GhostCellImplReplaceQualifs
...
end GhostCellImplReplaceQualifs

open GhostCellImplReplaceQualifs

def GhostCellImpl__Replace_proof : GhostCellImpl__Replace := by
  unfold GhostCellImpl__Replace
  try solve_fixpoint
