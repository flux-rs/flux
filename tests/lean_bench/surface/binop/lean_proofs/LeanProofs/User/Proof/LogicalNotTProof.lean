...
import LeanProofs.Flux.VC.LogicalNotT
open Classical
...
end LogicalNotTQualifs

open LogicalNotTQualifs

set_option maxHeartbeats 5000000
#time def LogicalNotT_proof : LogicalNotT := by
  unfold LogicalNotT
