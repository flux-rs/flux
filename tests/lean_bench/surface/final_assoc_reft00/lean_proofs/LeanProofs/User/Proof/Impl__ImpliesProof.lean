...
import LeanProofs.Flux.VC.Impl__Implies
open Classical

namespace F

namespace ImplImpliesQualifs
...
end ImplImpliesQualifs

open ImplImpliesQualifs

def Impl__Implies_proof : Impl__Implies := by
  unfold Impl__Implies
  try solve_fixpoint
