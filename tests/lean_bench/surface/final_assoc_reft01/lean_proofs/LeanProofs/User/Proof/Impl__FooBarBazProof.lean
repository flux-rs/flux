...
import LeanProofs.Flux.VC.Impl__FooBarBaz
open Classical

namespace F

namespace ImplFooBarBazQualifs
...
end ImplFooBarBazQualifs

open ImplFooBarBazQualifs

def Impl__FooBarBaz_proof : Impl__FooBarBaz := by
  unfold Impl__FooBarBaz
  try solve_fixpoint
