...
import LeanProofs.Flux.VC.Impl__Foreach
open Classical

namespace F

namespace ImplForeachQualifs
...
end ImplForeachQualifs

open ImplForeachQualifs

def Impl__Foreach_proof : Impl__Foreach := by
  unfold Impl__Foreach
  try solve_fixpoint
