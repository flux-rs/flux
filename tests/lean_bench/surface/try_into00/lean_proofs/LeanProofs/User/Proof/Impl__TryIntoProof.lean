...
import LeanProofs.Flux.VC.Impl__TryInto
open Classical

namespace F

namespace ImplTryIntoQualifs
...
end ImplTryIntoQualifs

open ImplTryIntoQualifs

def Impl__TryInto_proof : Impl__TryInto := by
  unfold Impl__TryInto
  try solve_fixpoint
