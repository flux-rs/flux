...
import LeanProofs.Flux.VC.Impl__Method1
open Classical

namespace F

namespace ImplMethod1Qualifs
...
end ImplMethod1Qualifs

open ImplMethod1Qualifs

def Impl__Method1_proof : Impl__Method1 := by
  unfold Impl__Method1
  try solve_fixpoint
