...
import LeanProofs.Flux.VC.Impl__EnableAppMpu
open Classical

namespace F

namespace ImplEnableAppMpuQualifs
...
end ImplEnableAppMpuQualifs

open ImplEnableAppMpuQualifs

def Impl__EnableAppMpu_proof : Impl__EnableAppMpu := by
  unfold Impl__EnableAppMpu
  try solve_fixpoint
