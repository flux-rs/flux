...
import LeanProofs.Flux.VC.Impl__FromState
open Classical

namespace F

namespace ImplFromStateQualifs
...
end ImplFromStateQualifs

open ImplFromStateQualifs

def Impl__FromState_proof : Impl__FromState := by
  unfold Impl__FromState
  try solve_fixpoint
