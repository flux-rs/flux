...
import LeanProofs.Flux.VC.Impl__Collision
open Classical

namespace F

namespace ImplCollisionQualifs
...
end ImplCollisionQualifs

open ImplCollisionQualifs

def Impl__Collision_proof : Impl__Collision := by
  unfold Impl__Collision
  try solve_fixpoint
