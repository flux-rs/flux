...
import LeanProofs.Flux.VC.MyModuleImpl__DoSomething
open Classical

namespace F

namespace MyModuleImplDoSomethingQualifs
...
end MyModuleImplDoSomethingQualifs

open MyModuleImplDoSomethingQualifs

def MyModuleImpl__DoSomething_proof : MyModuleImpl__DoSomething := by
  unfold MyModuleImpl__DoSomething
  try solve_fixpoint
