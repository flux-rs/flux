...
import LeanProofs.Flux.VC.CloseAtReturn
open Classical
...
namespace CloseAtReturnQualifs
...
end CloseAtReturnQualifs

open CloseAtReturnQualifs

set_option maxHeartbeats 5000000
#time def CloseAtReturn_proof : CloseAtReturn := by
