...
import LeanProofs.Flux.VC.SharedRefBox
open Classical
...
end SharedRefBoxQualifs

open SharedRefBoxQualifs

set_option maxHeartbeats 5000000
def SharedRefBox_proof : SharedRefBox := by
  unfold SharedRefBox
  try rewriteKs
  try fusion
  try solve_fixpoint
