...
import LeanProofs.Flux.VC.TestMapErrPreservesOk
open Classical
...
namespace TestMapErrPreservesOkQualifs
...
end TestMapErrPreservesOkQualifs

open TestMapErrPreservesOkQualifs

set_option maxHeartbeats 5000000
#time def TestMapErrPreservesOk_proof : TestMapErrPreservesOk := by
  unfold TestMapErrPreservesOk
