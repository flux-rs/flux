...
import LeanProofs.Flux.VC.TestSplitFirstBranch
open Classical
...
namespace TestSplitFirstBranchQualifs
...
end TestSplitFirstBranchQualifs

open TestSplitFirstBranchQualifs

set_option maxHeartbeats 5000000
def TestSplitFirstBranch_proof : TestSplitFirstBranch := by
