...
import LeanProofs.Flux.VC.TestSplitAtMutLengths
open Classical
...
namespace TestSplitAtMutLengthsQualifs
...
end TestSplitAtMutLengthsQualifs

open TestSplitAtMutLengthsQualifs

set_option maxHeartbeats 5000000
def TestSplitAtMutLengths_proof : TestSplitAtMutLengths := by
