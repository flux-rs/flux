...
import LeanProofs.Flux.VC.TestRangeIndexInBounds
open Classical
...
namespace TestRangeIndexInBoundsQualifs
...
end TestRangeIndexInBoundsQualifs

open TestRangeIndexInBoundsQualifs

set_option maxHeartbeats 5000000
#time def TestRangeIndexInBounds_proof : TestRangeIndexInBounds := by
