...
import LeanProofs.Flux.VC.TestSplitFirstEmpty
open Classical
...
namespace TestSplitFirstEmptyQualifs
...
end TestSplitFirstEmptyQualifs

open TestSplitFirstEmptyQualifs

set_option maxHeartbeats 5000000
def TestSplitFirstEmpty_proof : TestSplitFirstEmpty := by
