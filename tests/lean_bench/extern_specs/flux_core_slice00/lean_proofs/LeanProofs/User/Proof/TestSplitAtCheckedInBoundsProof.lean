...
import LeanProofs.Flux.VC.TestSplitAtCheckedInBounds
open Classical
...
namespace TestSplitAtCheckedInBoundsQualifs
...
end TestSplitAtCheckedInBoundsQualifs

open TestSplitAtCheckedInBoundsQualifs

set_option maxHeartbeats 5000000
def TestSplitAtCheckedInBounds_proof : TestSplitAtCheckedInBounds := by
