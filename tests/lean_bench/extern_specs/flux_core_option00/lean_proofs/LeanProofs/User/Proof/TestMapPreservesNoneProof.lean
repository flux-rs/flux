...
import LeanProofs.Flux.VC.TestMapPreservesNone
open Classical
...
namespace TestMapPreservesNoneQualifs
...
end TestMapPreservesNoneQualifs

open TestMapPreservesNoneQualifs

set_option maxHeartbeats 5000000
def TestMapPreservesNone_proof : TestMapPreservesNone := by
