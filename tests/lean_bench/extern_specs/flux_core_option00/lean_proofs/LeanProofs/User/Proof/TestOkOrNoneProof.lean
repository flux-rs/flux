...
import LeanProofs.Flux.VC.TestOkOrNone
open Classical
...
end TestOkOrNoneQualifs

open TestOkOrNoneQualifs

set_option maxHeartbeats 5000000
def TestOkOrNone_proof : TestOkOrNone := by
  unfold TestOkOrNone
