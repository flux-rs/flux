...
import LeanProofs.Flux.VC.TestUnwrapOr
open Classical
...
end TestUnwrapOrQualifs

open TestUnwrapOrQualifs

set_option maxHeartbeats 5000000
def TestUnwrapOr_proof : TestUnwrapOr := by
  unfold TestUnwrapOr
  try solve_fixpoint
