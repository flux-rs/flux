...
import LeanProofs.Flux.VC.TestCheckedMulIsize
open Classical
...
namespace TestCheckedMulIsizeQualifs
...
end TestCheckedMulIsizeQualifs

open TestCheckedMulIsizeQualifs

set_option maxHeartbeats 5000000
#time def TestCheckedMulIsize_proof : TestCheckedMulIsize := by
