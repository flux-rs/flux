...
import LeanProofs.Flux.VC.TestCheckedIsize
open Classical

namespace F

namespace TestCheckedIsizeQualifs
...
end TestCheckedIsizeQualifs

open TestCheckedIsizeQualifs

def TestCheckedIsize_proof : TestCheckedIsize := by
