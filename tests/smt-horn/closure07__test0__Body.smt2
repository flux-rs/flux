...
;; Tag 1: Ret at 8:1: 8:2 (ESpan { span: tests/pos/surface/closure07.rs:1:30: 1:33 (#0), base: None })
...
(assert (forall ((a0 Int)(a1 Int)(_$ Int)(a2 Int)(_$ Int)(a3 Int)(_$ Int)(a4 Int)(_$ Int)(a5 Int)(_$ Int)) (=> (and (k0 a1 a0) (k1 a2 a0) (k0 a3 a0) (k1 a4 a0) (= a5 (+ a4 1))) (k2 a5 a0))))
(assert (forall ((a0 Int)) (=> (not (=> false (or c0 false))) false)))
(assert (forall ((a0 Int)) (=> true (k0 a0 a0))))
(assert (forall ((a0 Int)) (=> true (k1 99 a0))))
(assert (forall ((a0 Int)(a6 Int)(_$ Int)) (=> (and (k2 a6 a0) (not (= a6 100))) false)))
