...
;; Tag 0: Ret at 28:12: 28:15 (ESpan { span: tests/pos/surface/local_qual00.rs:19:42: 19:61 (#0), base: None })
...
(assert (forall ((reftgen$a$0 Int)(_$ Int)(a0 Int)(a1 Int)(_$ Int)(_$ Int)(a2 Adt0)(_$ Int)) (=> (and (k0 a0 a1 reftgen$a$0) (k1 a1 reftgen$a$0) (not (< a0 reftgen$a$0)) (k2 (fld0$0 a2) (fld0$1 a2) a0 a1 reftgen$a$0) (k3 (fld0$1 a2) a0 a1 reftgen$a$0) (not (<= (+ (fld0$0 a2) (fld0$1 a2)) (+ reftgen$a$0 10)))) false)))
...
(assert (forall ((reftgen$a$0 Int)(_$ Int)(a0 Int)(a1 Int)(_$ Int)(_$ Int)) (=> (and (k0 a0 a1 reftgen$a$0) (k1 a1 reftgen$a$0) (< a0 reftgen$a$0)) (k4 (+ a0 10) (- reftgen$a$0 a0) reftgen$a$0 a0 a1))))
